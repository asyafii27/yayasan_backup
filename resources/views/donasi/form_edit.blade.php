    ...
    <div class="col-md-12">
        ...
        <form method="POST" action="{{ route('donasi.update', $row->id) }}" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="date" class="form-control" name="tgl_donasi" value="{{ $row->tgl_donasi }}"
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" name="jml_donasi" value="{{ $row->jml_donasi }}"
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    ...
                    @if (!empty($row->bukti_transfer))
                        <img src="{{ url('admin/images/bukti_transfer') }}/{{ $row->bukti_transfer }}" alt="Profile"
