        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-12 mx-auto">
                    <form class="custom-form donate-form" action="{{ route('donet.store') }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-12">
                                <input type="text" name="nama" value="{{ old('nama') }}" id="donation-name"
                            ...
                            <div class="col-lg-12 col-12">
                                <input type="text" name="keterangan" value="{{ old('keterangan') }}" id="donation-name"
                            ...
                            <div class="col-lg-12 col-12 form-check-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control @error('jml_donasi') is-invalid @enderror"
                                        placeholder="Masukan Jumlah Donasi" aria-label="Username"
                                        aria-describedby="basic-addon1" name="jml_donasi" value="{{ old('jml_donasi') }}">
                                    @error('jml_donasi')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col-lg-12 col-12 mt-2">
                                @foreach ($ar_metode_pembayaran as $mepem)
                                    ...
                                    <div class="form-check ms-2">
                                        <div class="d-flex align-items-center pb-2">
                                            <input
                                                class="form-check-input checkk  @error('metode_pembayaran_id') is-invalid @enderror"
                                                type="radio" name="metode_pembayaran_id" value="{{ $mepem->id }}"
                                                {{ $cek }}>
                                            <label class="form-check-label mb-auto" for="gridRadios1">
                                                &nbsp;&nbsp;<img
                                                    src="{{ url('admin/images/icon_pembayaran') }}/{{ $mepem->icon }}"
                                                    width="50px" alt="Profile"
                                                    class="rounded-circle">{{ $mepem->nama }}
                                            </label>
                                        </div>
                                    </div>
                                @endforeach
                                ...
                                <div class="Box" style="display:none">
                                    <div class="col-lg-12 col-12">
                                        ...
                                        <p>Silahkan melakukan transfer ke nomor <span id="test"
                                    ...
                                    <div class="col-sm-9">
                                        <input type="file"
                                            ...
                                            name="bukti_transfer" value="{{ old('bukti_transfer') }}">
