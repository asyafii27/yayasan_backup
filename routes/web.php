...
//ini untuk revisi di donet
Route::get('donetform', [DonetController::class, 'indexform']);
Route::get('/donet_bukti', [DonetController::class, 'bukti'])->name('buktidonasi');
...
// bagian donet
Route::get('donet-pdf/{id}', [DonetController::class, 'donetPDF'])->name('donetPDFlink');
